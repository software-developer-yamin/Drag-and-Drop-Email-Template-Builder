...
const SocialLinkSettings = () => {
  ...
  const { findStyleItem, paddingChange, updateItemStyles, cardItemElement } =
    useLayout();
    ...
    return (
      <>
        ...
        <div
          ...
          onDragEnd={() => {
            sourceNode.childNodes[0].classList.remove(
        ...
        <div className="card-item-title margin-top-18">
          {t("add_social_link")}
        </div>
